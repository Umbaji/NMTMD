ewe_to_english = {
    ...
    'afika': ['where'],
    'afima': ['there'],
    'Afua': ['name for a female born on Friday – 162 –'],
    'Aƒenɔ': ['Mrs., Lady'],
    ...
    'agble': ['farm', 'to farm – 167 –', 'to weed/clear a farm'],
    'agbleded': ['farming'],
    ...
    'atikewɔƒe': ['hospital, dispensary, clinic – 165 –'],
    'atikewɔla': ['doctor'],
    'atikpala': ['carpenter'],
    'atikpo/at': ['log'],
    'iboli': ['log'],
    ...
    'blaenyi': ['eighty'],
    'blaetɔ': ['thirty'],
    'blaeve': ['twenty (in some areas bláa̍ve) – 166 –'],
    ...
    'de': ['ti have been to, to arrive', 'native land, homeland', 'palm', 'to farm – 167 –', 'to attend school, to go to school', 'it is time, the time is up', 'the day comes, the time is up', 'to pledge (s omething), to entrust into someone’s care'],
    ...
    'na': ['to greet someone', 'to frighten someone', 'to succeed', 'to command/order', 'to allow, permit', 'to advise someone – 171 –', 'to request/order something from someone', 'to punish someone', 'to expect, to look forward to', 'to have mercy/pity on someone', 'to serve someone a drink', 'to give; for (prep.)', 'Good day to you', 'to pledge (s omething), to entrust into someone’s care', 'to give to', 'to care about/ care for/ to show interest in someone', 'to treat/cure someone', 'to save someone'],
    'ɣli': ['to shout'],
    ...
    'alɔ': ['to sleep'],
    'wu': ['to be hungry ("hunger kills someone")', 'to be thirsty – 189 –', 'to kill', 'to surpass', 'to end/finish doing something'],
    ...
    'klo': ['to kneel'],
    'ŋe': ['to lie face up, to lie on one’s back – 169 –', 'to break'],
    'si': ['to know/recognise someone', 'to run away – 186 –'],
    ...
    'dzrala': ['seller (see also núdzrálá ) – 170 –'],
    'dzu': ['to abuse/insult someone'],
    'ɖasefo': ['witness'],
    'xexe': ['to out', 'outside, outdoors'],
    'la': ['to fish', 'more over', 'animal, meat, flesh – 180 –'],
    'tɔmela': ['to fish', 'fish'],
    ...
    'ɖeke': ['no, none'],
    'o': ['no, none', 'not long after, soon – 172 –', 'not yet', 'never, never before', 'not'],
    'ɖes': ['every, each'],
    'iaɖe': ['every, each'],
    ...
    'ɣe': ['to dance', 'chalk, white clay', 'that time – 176 –', 'from that time, since then'],
    ...
    'eteƒe': ['not long after, soon – 172 –'],
    'medidi': ['not long after, soon – 172 –'],
    ...
    '(n.)': ['theft'],
    'fiafi': ['thief'],
    'fiafitɔ': ['thief (a professional or habitual) – 173 –'],
    'fiakuku': ['crown'],
    'fiasa': ['palace'],
    'fiase': ['shop, store'],
    ...
    'dama': ['green grass'],
    'ma': ['that day', 'that time – 176 –', 'that – 181 –', 'to part company', 'to share/divide', 'from that time, since then'],
    ...
    'ɣi': ['that time – 176 –', 'sometimes, at times', 'white (attr.)', 'from that time, since then'],
    ...
    'kɔ': ['to be neat, to be clean/without sin – 178 –', 'to be tall/high', 'to pour libation (an African custom)', 'to pour into/out', 'to pour into/out', 'to speak out/up, to raise one’s voice, to speak louder', 'to sling on the neck (e.g. bag)'],
    ...
    'Kpedze': ['name of an Eʋ e town in Ghana – 179 –'],
    'kpekpe': ['heavy'],
    'kpekpeme': ['weight'],
    'kpeto': ['cave'],
    'kpla': ['to embrace'],
    ...
    'nyɔnu': ['woman'],
    'nyɔnuvi': ['girl'],
    'nyɔnuwu': ['dress, women’s wear – 184 –'],
    ...
    'petee': ['completely, entirely, altogether (see also kéŋ́kéŋ́ )'],
    'priku': ['mongoose (see also axlɔ̃́ẽ ́)'],
    'sabala': ['onion'],
    ...
    'srɔŋutsu': ['husband (see also atsú)'],
    ...
    'yi': ['to turn and go (back) to', 'to go', 'cutlass, matchet (see also kra̍nté)', 'to come with someone', 'to continue (doing something)'],
